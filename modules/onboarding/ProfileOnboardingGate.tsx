...
import { ProfilePicSelector } from '@/components/korui/image/ProfilePicSelector';
import { useImagePicker } from '@/components/korui/image/useImagePicker';
...
export const ProfileOnboardingGate: React.FunctionComponent<{
  ...
  const submit = async () => {
    ...
    await api.updateProfile({
      ...
      profilePicUri: { value: profilePicUri ?? undefined }
    });
