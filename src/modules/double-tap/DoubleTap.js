...
export class DoubleTap extends Component {
  constructor(props) {
    ...
    this.delayTime = props.delay ? props.delay : 400;
  ...
  render() {
    const Touchable = this.props.Touchable ?? TouchableWithoutFeedback;
    return <Touchable onPress={this._onPress}>{this.props.children}</Touchable>;
  }
